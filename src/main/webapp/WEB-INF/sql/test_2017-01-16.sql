...
# Database: test
# Generation Time: 2017-01-16 08:43:25 +0000
# ************************************************************
...
VALUES
	(2,0,'user','','用户管理',00000001,0),
	(3,2,'user','list','用户列表',00000001,0),
	(4,0,'sysmenu','','菜单管理',00000001,0),
	(5,4,'sysmenu','list','菜单列表',00000001,0),
	(6,4,'sysmenu','edit','修改菜单',00000000,0),
	(7,0,'game','','游戏管理',00000001,0),
	(8,0,'log','','日志管理',00000001,0),
	(9,0,'resource','','资源管理',00000001,0),
	(12,2,'user','add','添加用户',00000000,0),
	(13,2,'user','edit','编辑用户',00000000,0),
	(14,2,'user','power','权限管理',00000000,0),
	(15,4,'sysmenu','add','添加菜单',00000000,0),
	(16,0,'group','','组管理',00000001,0),
	(17,16,'group','list','组列表',00000001,0),
	(18,16,'group','add','添加组',00000000,0),
	(19,16,'group','edit','编辑组',00000000,0),
	(20,16,'group','power','组权限管理',00000000,0),
	(21,0,'schema','','架构管理',00000001,0),
