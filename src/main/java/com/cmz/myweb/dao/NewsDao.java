...
public interface NewsDao {
	...
	public final static String fields = "`id`,`title`,`imgsrc`,`bigid`,`smallid`,`desc`,`content`,`hit`,`pdate`";
	...
	@Insert("INSERT INTO "+Table+"("+fields+")VALUES(0,#{n.title},#{n.imgsrc},#{n.bigid},#{n.smallid},#{n.desc},#{n.content},0,#{n.pdate})")
	public int add(@Param("n")News news);
	
	@Update("UPDATE "+Table+" SET `title`=#{n.title},#{n.imgsrc},`bigid`=#{n.bigid},`smallid`=#{n.smallid},`desc`=#{n.desc},`content`=#{n.content} WHERE `id`=#{n.id}")
